...
function ss_cisco_cpu_get_desc(
    $hostname,
    $snmp_community,
    $indexoid,
    $descoid,
    ...
    $index_arr = ss_cisco_cpu_reindex(cacti_snmp_walk(
        $hostname,
        $snmp_community,
        $indexoid,
        $snmp_version,
...
function ss_cisco_cpu_get_usage(
    $hostname,
    $snmp_community,
    $oid,
    $snmp_version,
    ...
    return ss_cisco_cpu_reindex(cacti_snmp_walk(
        $hostname,
        $snmp_community,
        $oid,
        $snmp_version,
...
function ss_cisco_cpu_get_indexes(
    $hostname,
    $snmp_community,
    $oid,
    $snmp_version,
